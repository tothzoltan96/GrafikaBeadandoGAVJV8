...
//  GrafikaBeadando
//
//  Created by Tóth Zoltán on 2022. 04. 16..
//  Copyright © 2022. Tóth Zoltán. All rights reserved.
//
...
class ViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    let detectionQueue = DispatchQueue(label: "detection", qos: .userInitiated, attributes: [], autoreleaseFrequency: .workItem)
